...
[0] = LAYOUT_planck_grid(
  ...
  KC_ESC,  KC_LGUI, KC_LALT, KC_RCTRL, KC_LSFT, KC_SPC, M(1),    M(2), XXXXXXX, XXXXXXX, XXXXXXX, KC_PSCR
),
...
[1] = LAYOUT_planck_grid(
  ...
  _______, KC_VOLD, KC_PAUS, KC_MPRV, KC_MNXT, KC_PGDN, KC_HOME, KC_END,  _______, KC_BSLS, _______, _______,
