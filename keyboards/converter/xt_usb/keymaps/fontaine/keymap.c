...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     */
    LAYOUT_xt( \
    KC_F1,  KC_F2,    KC_ESC, KC_1,   KC_2,   KC_3,   KC_4,   KC_5,   KC_6,   KC_7,   KC_8,   KC_9,   KC_0,    KC_EQL, KC_GRV,   KC_BSPC,    KC_NLCK,        KC_SLCK,
    KC_F3,  KC_F4,    KC_TAB, KC_Q,   KC_W,   KC_F,   KC_P,   KC_G,   KC_J,   KC_L,   KC_U,   KC_Y,   KC_SCLN, KC_MINS,KC_RBRC,           KC_P7,  KC_P8,  KC_P9,  KC_PMNS,
    KC_F5,  KC_F6,    KC_BSPC,KC_A,   KC_R,   KC_S,   KC_T,   KC_D,   KC_H,   KC_N,   KC_E,   KC_I,   KC_O,    KC_QUOT,KC_LBRC,   KC_ENT, KC_P4,  KC_P5,  KC_P6,
    KC_F7,  KC_F8,    KC_LSFT,KC_LSFT,KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   KC_K,   KC_M,   KC_COMM,KC_DOT,  KC_SLSH,KC_ENT,   KC_PSCR, KC_P1,  KC_P2,  KC_P3,  KC_PPLS,
    KC_F9,  KC_F10,   KC_LCTL,                                    KC_SPC,                                              KC_LALT,               KC_P0,   KC_PDOT
    ),
