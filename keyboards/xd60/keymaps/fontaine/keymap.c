...
LAYOUT_66(
  ...
  KC_ESC, KC_LALT, KC_LCTL,       KC_NO,      MO(1),    KC_LSFT,       KC_SPC, KC_NO,  KC_RGUI,        KC_LEFT,  KC_DOWN,  KC_RIGHT),
...
LAYOUT_66(
  ...
  _______,          RGB_HUI, RGB_SAI, RGB_VAI, KC_PGUP,KC_DEL, KC_LBRC,KC_LEFT,KC_UP,  KC_DOWN, KC_RIGHT,_______,  _______,  _______,   \
  _______, _______, RGB_HUD, RGB_SAD, RGB_VAD, KC_PGDN,KC_ESC, KC_RBRC,KC_HOME,KC_END, _______, KC_BSLS, _______,  _______,  _______,   \
