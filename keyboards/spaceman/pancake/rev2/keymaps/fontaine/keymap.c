...
[1] = LAYOUT_ortho_4x12(
  ...
  _______, KC_VOLU, KC_MUTE, KC_MSTP, KC_MPLY, KC_PGUP, KC_LBRC, KC_LEFT, KC_UP,   KC_DOWN, KC_RGHT, KC_GRV,
  _______, KC_VOLD, KC_PAUS, KC_MPRV, KC_MNXT, KC_PGDN, KC_RBRC, KC_HOME,  KC_END, KC_BSLS, _______, _______,
